...
eleva.tif <- rast("M:/dissertation/RAllTries/data/elevation.tif")
pop.tif <- rast("M:/dissertation/RAllTries/data/ken_general_2020.tif")
lc.tif <- rast("M:/dissertation/RAllTries/data/PROBAV_LC100_global_v3.0.1_2019-nrt_Discrete-Classification-map_EPSG-4326.tif")
lc.bare.tif <- rast("M:/dissertation/RAllTries/data/fractional_cover_lc100/PROBAV_LC100_global_v3.0.1_2019-nrt_Bare-CoverFraction-layer_EPSG-4326.tif")

#read in the rectangle
rectangle <-st_read("M:/dissertation/RAllTries/data/rectangle.shp")
